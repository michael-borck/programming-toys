...
contradictory set and watch it collapse to zero, which is worse than it sounds, because a real
agent won't tell you.

**Pairs with:** Lab 3 — *Say What You Mean* (`programming-labs`), where the same experience runs
live with real agents.

Built from [`SPEC.md`](SPEC.md), like every toy in this collection — run the Replication Test on
it if you don't believe us. Add `?present` for a projector.
